...
#### 输出1: AI分析报告（保留当前格式）
- **文件名**: `docs/01_需求发现报告.md`
- **格式**: 当前AI自定义格式
- **内容**: 包含详细的分析、问题识别、复杂度评估等
- **目的**: 保留AI的深度分析内容

#### 输出2: 标准化需求文档（必须按模板）
- **瀑布流模式（高复杂度）**:
  - `docs/02_用户需求规格说明书_v2.2.md`
  - `docs/03_系统需求规格说明书_v3.9.md`
- **敏捷模式（中/低复杂度）**:
  - `docs/02_Epic.md`
  - `docs/03_Feature.md`
  - `docs/04_Story.md`
...
```
docs/
├── 01_需求发现报告.md                    # AI分析报告（自定义格式）
├── 02_用户需求规格说明书_v2.2.md         # 标准化文档（瀑布流）
├── 03_系统需求规格说明书_v3.9.md         # 标准化文档（瀑布流）
└── requirements/                          # 或敏捷模式
    ├── Epic.md
    ├── Feature.md
    └── Story.md
